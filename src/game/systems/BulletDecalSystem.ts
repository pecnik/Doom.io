...
export class BulletDecalSystem extends System {
    ...
    public constructor(world: World) {
        ...
        this.pool = this.createDecalMeshPool();
        world.scene.add(this.pool);
        world.addEntityListener({
            onEntityAdded: (entity: Entity) => {
                if (this.family.includesEntity(entity)) {
                    this.removeOverlappingDecals(world, entity);
                    this.spawnDecalMesh(world, entity);
                }
            },
    ...
    private removeOverlappingDecals(world: World, entity: Entity) {
    ...
    private spawnDecalMesh(world: World, entity: Entity) {
        const mesh = this.pool.children.find(m => !m.visible) as Mesh;
